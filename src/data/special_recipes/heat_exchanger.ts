...
export const heat_exchanger_distilled_water: SpecialRecipe = {
  id: 'r_heat_exchanger_01',
  name: 'Distilled Water Coolant',
  machine_id: 'm_heat_exchanger',
  description:
    'Feed distilled water and distilled water into the heat exchanger. Coolant heats the water to produce high pressure steam.',
  settings: {
    water_temp: {
      type: 'number',
...
export const heat_exchanger_contaminated_water: SpecialRecipe = {
  id: 'r_heat_exchanger_02',
  name: 'Contaminated Water Coolant',
  machine_id: 'm_heat_exchanger',
  description:
    'Feed distilled water and contaminated water into the heat exchanger. Coolant heats the water to produce high pressure steam.',
  settings: {
    water_temp: {
      type: 'number',
      label: 'Water Temperature (°C)',
